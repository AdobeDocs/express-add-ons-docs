...
- subPages:
    ...
    - [Document Sandbox](references/document-sandbox/index.md)
        ...
        - [Document APIs](references/document-sandbox/document-apis/index.md)
            - [Classes](references/document-sandbox/document-apis/classes/editor.md)
                ...
                - [BitmapImage](references/document-sandbox/document-apis/classes/bitmap-image.md)
                ...
                - [ExpressContext](references/document-sandbox/document-apis/classes/express-context.md)
                - [ExpressEditor](references/document-sandbox/document-apis/classes/express-editor.md)
                - [ExpressRootNode](references/document-sandbox/document-apis/classes/express-root-node.md)
                - [ExpressViewport](references/document-sandbox/document-apis/classes/express-viewport.md)
                ...
                - [MediaRectangleNode](references/document-sandbox/document-apis/classes/media-rectangle-node.md)
                ...
                - [ReadOnlyMask](references/document-sandbox/document-apis/classes/read-only-mask.md)
                ...
                - [StandaloneTextContentModel](references/document-sandbox/document-apis/classes/standalone-text-content-model.md)
                - [StandaloneTextNode](references/document-sandbox/document-apis/classes/standalone-text-node.md)
                ...
                - [TextNodeContentModel](references/document-sandbox/document-apis/classes/text-node-content-model.md)
                - [ThreadedTextContentModel](references/document-sandbox/document-apis/classes/threaded-text-content-model.md)
                - [ThreadedTextList](references/document-sandbox/document-apis/classes/threaded-text-list.md)
                - [ThreadedTextNode](references/document-sandbox/document-apis/classes/threaded-text-node.md)
                - [UnavailableFont](references/document-sandbox/document-apis/classes/unavailable-font.md)
                - [UnknownMediaRectangleNode](references/document-sandbox/document-apis/classes/unknown-media-rectangle-node.md)
            ...
            - [Interfaces](references/document-sandbox/document-apis/interfaces/area-text-layout.md)
                ...
                - [CommonResizeOptions](references/document-sandbox/document-apis/interfaces/common-resize-options.md)
                ...
                - [IMediaContainerNode](references/document-sandbox/document-apis/interfaces/i-media-container-node.md)
                - [INodeBounds](references/document-sandbox/document-apis/interfaces/i-node-bounds.md)
                ...
                - [IVisualNodeBounds](references/document-sandbox/document-apis/interfaces/i-visual-node-bounds.md)
                ...
                - [RemoveListStyleInput](references/document-sandbox/document-apis/interfaces/remove-list-style-input.md)
                - [ReplaceMediaWithEditedImageOptions](references/document-sandbox/document-apis/interfaces/replace-media-with-edited-image-options.md)
                - [RescaleProportionalToHeightOptions](references/document-sandbox/document-apis/interfaces/rescale-proportional-to-height-options.md)
                - [RescaleProportionalToWidthOptions](references/document-sandbox/document-apis/interfaces/rescale-proportional-to-width-options.md)
                - [ResizeUsingHeightOptions](references/document-sandbox/document-apis/interfaces/resize-using-height-options.md)
                - [ResizeUsingWidthOptions](references/document-sandbox/document-apis/interfaces/resize-using-width-options.md)
                - [SolidColorStroke](references/document-sandbox/document-apis/interfaces/solid-color-stroke.md)
                ...
                - [TextContent](references/document-sandbox/document-apis/interfaces/text-content.md)
                - [TextFrameAreaGeometry](references/document-sandbox/document-apis/interfaces/text-frame-area-geometry.md)
            ...
            - [Constants](references/document-sandbox/document-apis/constants/overview.md)
                ...
                - [OrderedListNumbering](references/document-sandbox/document-apis/enumerations/ordered-list-numbering.md)
                - [ParagraphListType](references/document-sandbox/document-apis/enumerations/paragraph-list-type.md)
                - [ResizeBehavior](references/document-sandbox/document-apis/enumerations/resize-behavior.md)
                ...
                - [TextScriptStyle](references/document-sandbox/document-apis/enumerations/text-script-style.md)
                - [TextStyleSource](references/document-sandbox/document-apis/enumerations/text-style-source.md)
            ...
            - [Types](references/document-sandbox/document-apis/type-aliases/editor-event-handler.md)
                ...
                - [ListStyleInput](references/document-sandbox/document-apis/type-aliases/list-style-input.md)
                - [OrderedListStyle](references/document-sandbox/document-apis/type-aliases/ordered-list-style.md)
                - [ResizeOptions](references/document-sandbox/document-apis/type-aliases/resize-options.md)
    ...
    - [Project Anatomy](guides/getting-started/addon-project-anatomy.md)
    ...
    - [Dev MCP Server](guides/getting-started/local-development/mcp-server.md)
    - [Local Development](guides/getting-started/local-development/dev-tooling.md)
        ...
        - [Known Issues & Limitations](guides/getting-started/local-development/known-issues-limitations.md)
    ...
    - [How-to](guides/learn/how-to/index.md)
        ...
        - [Document Structure](guides/learn/how-to/manage-pages.md)
            - [Manage Pages](guides/learn/how-to/manage-pages.md)
            - [Support Large Documents](guides/learn/how-to/large-document-support.md)
        - [Use Design Elements](guides/learn/how-to/use-text.md)
            ...
            - [Handle Element Selection](guides/learn/how-to/handle-selection.md)
            - [Group Elements](guides/learn/how-to/group-elements.md)
            - [Resize Elements](guides/learn/how-to/resize-elements.md)
    ...
    - [Platform Concepts](guides/learn/platform-concepts/architecture.md)
        ...
        - [Large Document Support](guides/learn/platform-concepts/large-document-support.md)
    - [SDK Fundamentals](guides/learn/fundamentals/terminology.md)
        ...
        - [Use Document Sandbox Constants](guides/learn/fundamentals/document-sandbox-constants.md)
