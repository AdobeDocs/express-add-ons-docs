...
- subPages:
    ...
    - [Getting Started](guides/index.md) header
        ...
        - [Developer Journey](guides/getting_started/developer-journey.md) 
        - [Hello, World!](guides/getting_started/hello-world.md) 
        - [Code Playground](guides/getting_started/code-playground.md) 
        - [Local Development](guides/getting_started/local_development/dev-tooling.md) 
            - [Development tools](guides/getting_started/local_development/dev-tooling.md) 
            - [Browser debugging](guides/getting_started/local_development/browser.md) 
            - [VS Code debugging](guides/getting_started/local_development/vs-code.md) 
        - [What's new](guides/getting_started/changelog.md) 
    - [Learn](guides/learn/how_to/index.md) header
        - [How-to](guides/learn/how_to/index.md) 
            - [About](guides/learn/how_to/index.md) 
            - [Authentication & Authorization](guides/learn/how_to/oauth2.md) 
                - [Use OAuth 2.0](guides/learn/how_to/oauth2.md) 
            - [Data & Environment](guides/learn/how_to/local-data-management.md) 
                - [Store Data](guides/learn/how_to/local-data-management.md) 
                - [Theme & Locale](guides/learn/how_to/theme-locale.md) 
            - [UI & Interaction](guides/learn/how_to/drag-and-drop.md) 
                - [Use Drag & Drop](guides/learn/how_to/drag-and-drop.md) 
                - [Use Modal Dialogs](guides/learn/how_to/modal-dialogs.md) 
            - [Use Design Elements](guides/learn/how_to/use-text.md) 
                - [Use Text](guides/learn/how_to/use-text.md) 
                - [Use Geometry](guides/learn/how_to/use-geometry.md) 
                - [Use Color](guides/learn/how_to/use-color.md) 
                - [Use Images](guides/learn/how_to/use-images.md) 
                - [Use Videos](guides/learn/how_to/use-videos.md) 
                - [Use Audio](guides/learn/how_to/use-audio.md) 
                - [Use PDF and PowerPoint](guides/learn/how_to/use-pdf-powerpoint.md) 
                - [Group Elements](guides/learn/how_to/group-elements.md) 
                - [Position Elements](guides/learn/how_to/position-elements.md) 
            - [Use Metadata](guides/learn/how_to/document-metadata.md) 
                - [Document](guides/learn/how_to/document-metadata.md) 
                - [Page](guides/learn/how_to/page-metadata.md) 
                - [Element](guides/learn/how_to/element-metadata.md) 
            - [Exporting & Output](guides/learn/how_to/create-renditions.md) 
                - [Create Renditions](guides/learn/how_to/create-renditions.md) 
                - [Manage Premium Content](guides/learn/how_to/premium-content.md) 
            - [User Info](guides/learn/how_to/user-info.md) 
            ...
            - [Complete Projects](guides/learn/how_to/tutorials/index.md) 
                ...
                - [Using Lit & TypeScript](guides/learn/how_to/tutorials/using-lit-typescript.md) 
        - [Platform Concepts](guides/learn/platform_concepts/context.md) 
            - [Add-on iframe Context](guides/learn/platform_concepts/context.md) 
            - [The Document API](guides/learn/platform_concepts/document-api.md) 
    ...
    - [Build](guides/build/advanced-topics/frameworks-libraries-bundling.md) header
        ...
        - [Design](guides/build/design/index.md) 
            ...
            - [UX Guidelines](guides/build/design/ux_guidelines/introduction.md) 
                - [Introduction](guides/build/design/ux_guidelines/introduction.md) 
                - [Design Principles](guides/build/design/ux_guidelines/design-principles.md) 
                - [Theming](guides/build/design/ux_guidelines/theming.md) 
                - [Visual Elements](guides/build/design/ux_guidelines/visual-elements.md) 
                - [Feedback & Messaging](guides/build/design/ux_guidelines/feedback-and-messaging.md) 
                - [Branding Guidelines & Distribution](guides/build/design/ux_guidelines/branding-guidelines.md) 
