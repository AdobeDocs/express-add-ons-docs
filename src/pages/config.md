...
- subPages:
    ...
    - [Getting Started](guides/index.md) header
        ...
        - [Local Development](guides/getting-started/local-development/dev-tooling.md) 
            ...
            - [Adobe Express Add-on MCP Server (Beta)](guides/getting-started/local-development/mcp-server.md) 
    ...
    - [Learn](guides/learn/how-to/index.md) header
        - [How-to](guides/learn/how-to/index.md) 
            ...
            - [Complete Projects](guides/learn/how-to/tutorials/index.md) 
                - [Document APIs](guides/learn/how_to/tutorials/grids-addon) 
                ...
                - [Using Adobe Spectrum](guides/learn/how_to/tutorials/spectrum-workshop/) 
                    ...
                    - [Tips & Troubleshooting](guides/learn/how_to/tutorials/spectrum-workshop/part3/) 
    ...
    - [Build](guides/build/advanced-topics/frameworks-libraries-bundling.md) header
        ...
        - [Distribute](guides/build/distribute/index.md) 
            - [Overview](guides/build/distribute/) 
            - [Our review process](guides/build/distribute/review_process/) 
            ...
            - [Guidelines and requirements](guides/build/distribute/guidelines) 
                - [General guidelines](guides/build/distribute/guidelines/general/) 
                ...
                - [Generative AI guidelines](guides/build/distribute/guidelines/genai/) 
                    - [Overview](guides/build/distribute/guidelines/genai/) 
