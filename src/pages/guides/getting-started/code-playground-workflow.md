...
![Code Playground Debugging](src/pages/guides/getting-started/img/playground-console-prefix.png)
...
![Code Playground Saved Session](src/pages/guides/getting-started/img/playground--saved-session.png)
...
![Code Playground Add-on Mode](src/pages/guides/getting-started/img/playground--sessions-from-home.gif)
...
![Code Playground Add-on Mode](src/pages/guides/getting-started/img/playground--sessions.gif)
...
![Code Playground Rename Session](src/pages/guides/getting-started/img/playground--rename-session.gif)
...
![Code Playground Delete Session](src/pages/guides/getting-started/img/playground--delete-session.gif)
...
![Code Playground Download code](src/pages/guides/getting-started/img/playground--download.png)
...
![Downloaded Folder Structure](src/pages/guides/getting-started/img/downloaded-folder-structure.png)
