...
The **[Adobe Express add-on CLI](./local-development/dev-tooling.md#using-the-cli) (Command Line Interface) is required for add-on development** and allows you to create and host Adobe Express add-ons directly from your local machine.
...
If you're ready to dive into our developer platform, we highly recommend following the [tutorials](../learn/how_to/tutorials/index.md), and exploring our collection of [code samples](../learn/samples.md). These samples provide hands-on examples of how to use our platform SDKs and APIs and are a great resource to help you get started building your own add-ons.
