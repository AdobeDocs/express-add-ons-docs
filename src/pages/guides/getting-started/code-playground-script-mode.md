...
Script Mode in Code Playground is the quickest way to try out [Document APIs](../learn/platform-concepts/document-api.md) that interact with Express document directly without the need for a full user interface.
...
![Code Playground Script Mode](src/pages/guides/getting-started/img/script-mode2.png)
...
![Script Mode Manifest Settings](src/pages/guides/getting-started/img/manifest-props-script.png)
...
Head over to our [How-to guides](../learn/how-to/index.md) to see some examples of using the Document APIs with example code snippets:
