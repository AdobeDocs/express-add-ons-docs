...
![Code Playground Add-on Mode](src/pages/guides/getting-started/img/addon-mode2.png)
...
![Add-on Mode Manifest Settings](src/pages/guides/getting-started/img/manifest-props-addon.png)
