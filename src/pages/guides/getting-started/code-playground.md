...
![Code Playground Overview](src/pages/guides/getting-started/img/playground--hero.png)
...
[![Code Playground Launch](src/pages/guides/getting-started/img/playground--splash-screen.png)](https://www.adobe.com/go/addon-playground)
...
![Code Playground from Home Screen](src/pages/guides/getting-started/img/playground--launch-from-home.gif)
...
![Code Playground from Home Screen](src/pages/guides/getting-started/img/playground--launch-from-doc.gif)
...
[![Playground Terms of Use](src/pages/guides/getting-started/img/playground--DTOU.png)](https://www.adobe.com/go/addon-playground)
