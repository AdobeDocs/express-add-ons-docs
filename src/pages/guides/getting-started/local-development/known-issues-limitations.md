...
![Local Network Access Error](src/pages/guides/getting-started/local-development/img/known-issues--allow-connect.png)
...
![Local Network Access Error](src/pages/guides/getting-started/local-development/img/known-issues--blocked.png)
...
![Site settings](src/pages/guides/getting-started/local-development/img/known-issues--site-info.png)

3. In the page that opens, click on both the **Delete data** and **Reset Permissions** buttons.

![Clear data](src/pages/guides/getting-started/local-development/img/known-issues--clear-data.png)
...
Add-ons run in a sandboxed iframe environment with certain restrictions. See the [Add-on Context guide](../../learn/platform-concepts/context.md) for details on permissions and limitations.
