...
![New launch.json file option](src/pages/guides/getting-started/local-development/img/new-launch-json.png)
...
![launch.json file](src/pages/guides/getting-started/local-development/img/vscode-debug-option.png)

![launch profiles](src/pages/guides/getting-started/local-development/img/launch-profiles.png)

Once you have your selection set from above, simply hit the green play button outlined below to start debugging.

![start debugging](src/pages/guides/getting-started/local-development/img/start-debug.png)
...
![debugging screenshot](src/pages/guides/getting-started/local-development/img/debugging.png)
...
![debugging tools](src/pages/guides/getting-started/local-development/img/debugger-tool.png)
