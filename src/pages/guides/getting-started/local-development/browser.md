...
**Chrome Users:** If you're using Chrome version 142 or later, you may encounter a "Local Network Access" permission prompt when loading your local add-on. Make sure to click "Allow" to continue development. See the [Known Issues & Limitations](../../getting-started/local-development/known-issues-limitations.md#chrome-local-network-access-restriction) guide for more details.
...
![inspect](src/pages/guides/getting-started/local-development/img/inspect.png)
...
![locate source](src/pages/guides/getting-started/local-development/img/find-source.png)
...
![custom levels](src/pages/guides/getting-started/local-development/img/log-levels.png)
...
![console.dir method](src/pages/guides/getting-started/local-development/img/dir-method.png)
...
![add-ons tools screenshot](src/pages/guides/getting-started/local-development/img/add-on-devtools.png)
...
![manifest error screenshot](src/pages/guides/getting-started/local-development/img/manifest-error.png)
...
![add-ons tools clear data screenshot](src/pages/guides/getting-started/local-development/img/clear-data.png)
...
![application tab indexed db screenshot](src/pages/guides/getting-started/local-development/img/application-indexed-db.png)
