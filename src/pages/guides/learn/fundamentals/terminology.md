...
For a comprehensive deep-dive into the dual-runtime architecture with visual diagrams, communication patterns, and code examples, see the [Add-on Architecture Guide](../platform-concepts/architecture.md) and the [Communication APIs Tutorial](../../learn/how_to/tutorials/stats-addon.md).
