...
**Architecture Context**: This guide covers the security aspects of the iframe runtime. For a comprehensive understanding of how the iframe runtime fits into the overall add-on architecture, see the [Add-on Architecture Guide](../platform-concepts/architecture.md).
...
![Show CORS errors in Chrome screenshot](src/pages/guides/learn/platform-concepts/images//show-cors.png)
...
![CORS diagram](src/pages/guides/learn/platform-concepts/images//cors-demo.png)
...
- [Add-on Architecture Guide](../platform-concepts/architecture.md) - Understanding the dual-runtime system and how the iframe runtime fits into the overall architecture
...
- [Premium Content Guide](../how-to/premium-content.md) - Implementing premium content flows with required permissions
