...
In this article, you'll dive deep into the architecture and key elements of the Adobe Express Document Object Model (DOM) and why the [Document API Reference Documentation](/references/document-sandbox/document-apis/index.md) is the primary tool to explore it.

<InlineAlert variant="info" slots="header, text1"/>

**Document Sandbox Only**

The Document APIs covered in this guide (accessed via the Express Document SDK) **only run in the document sandbox environment** (`code.js` file). They are not available in the iframe runtime. See the [Architecture Guide](../platform-concepts/architecture.md) to understand the dual-runtime system and how to use communication APIs to bridge between your UI and document manipulation code.
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-log.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-scenegraph.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-hierarchy.png)

### How to read the Document API Reference

With this knowledge, you can use the [Document API Reference Documentation](/references/document-sandbox/document-apis/index.md) as the primary tool to study and learn about the Adobe Express DOM. This reference documents all the classes, interfaces, and constants available in the Express Document SDK for the document sandbox environment.

![](src/pages/guides/learn/platform-concepts/images//refs-addon-doc.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-ref.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-accessor.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-stroke.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-strokeposition.png)
...
![](src/pages/guides/learn/platform-concepts/images//stats-addon-animation.gif)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-intellisense.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-allchildren.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-mediacontainer.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-draw.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-refactor.png)
...
![](src/pages/guides/learn/platform-concepts/images//refs-addon-unsupported.png)
