...
![Runtime Architecture Diagram](src/pages/guides/learn/platform-concepts/images/architecture.svg)
...
The Adobe Express [Code Playground](../../getting-started/code-playground.md) has special behavior where the `express-document-sdk` is automatically injected in Script mode. In production add-ons, you must always use explicit import statements as shown above.
