...
Many how-to guides now include a **"Try"** button that opens the code sample directly in the [Code Playground](../../getting-started/code-playground.md). Click the button to instantly test Document API samples in Script mode without setting up a local development environment!
...
|                                | [Resize & Rescale Elements](resize-rescale-elements.md) |
|                                | [Handle Selection](handle-selection.md)                 |
| Manage Pages                   | [Manage Pages](manage-pages.md)                         |
