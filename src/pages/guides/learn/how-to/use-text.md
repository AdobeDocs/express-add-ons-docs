...
2. **Style Sources**: Use [`TextStyleSource`](../../../references/document-sandbox/document-apis/enumerations/text-style-source.md) constants to inherit styles from existing text.
