...
For detailed page information including content analysis and print readiness, see the [Page Metadata Ho-to Guide](page-metadata.md).
...
Pages created with `editor.documentRoot.pages.addPage()` can be used with other Document APIs, particularly for retrieving metadata. See the [Page Metadata How-to Guide](page-metadata.md) for complete examples.
...
- **[Page Metadata](page-metadata.md)** - Retrieve detailed page information including dimensions, content analysis, and print readiness
