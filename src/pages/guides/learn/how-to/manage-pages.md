...
```js-data-playground-session-id="addStandardPage"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"
...
```js-data-playground-session-id="addContentToNewPage"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"
