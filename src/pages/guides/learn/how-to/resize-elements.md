...
![Resize by Width](../how_to/images/rescale--rescale-proportional-width.png)
...
![Resize by Height](../how_to/images/rescale--rescale-proportional-height.png)
...
![Preserve Visual Details](../how_to/images/resize--proportional-styles.png)
...
![Resize to Fit Within Bounds (Shapes)](../how_to/images/rescale--resize-within-ellipse.png)
...
![Resize to Fit Within Bounds (Shapes) with One Dimension](../how_to/images/resize--cover-one-dimension.png)
...
![Resize to Fit Within Bounds (Media)](../how_to/images/resize--contain-media.png)
...
![Resize to Fit Within Bounds (Media) reverse transformation](../how_to/images/resize--within-media-crop.png)
...
![Resize to Cover](../how_to/images/resize-to-cover.png)
