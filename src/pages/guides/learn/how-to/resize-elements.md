...
The `resize()` method accepts a [`ResizeOptions`](../../../references/document-sandbox/document-apis/type-aliases/resize-options.md) object with three mandatory components:

1. **Dimensions**: Specify `width`, `height`, or both (depending on the behavior).
2. **Behavior**: Controls aspect ratio handling via [`ResizeBehavior`](../../../references/document-sandbox/document-apis/enumerations/resize-behavior.md) enumeration.
3. **Visual Details**: Choose whether to scale strokes, corners detailing, etc.

### Resize Behaviors

Defined in the [`ResizeBehavior`](../../../references/document-sandbox/document-apis/enumerations/resize-behavior.md) enumeration.
...
![Resize by Width](src/pages/guides/learn/how-to/images/rescale--rescale-proportional-width.png)
...
![Resize by Height](src/pages/guides/learn/how-to/images/rescale--rescale-proportional-height.png)
...
![Preserve Visual Details](src/pages/guides/learn/how-to/images/resize--proportional-styles.png)
...
![Resize to Fit Within Bounds (Shapes)](src/pages/guides/learn/how-to/images/rescale--resize-within-ellipse.png)
...
![Resize to Fit Within Bounds (Shapes) with One Dimension](src/pages/guides/learn/how-to/images/resize--cover-one-dimension.png)
...
![Resize to Fit Within Bounds (Media)](src/pages/guides/learn/how-to/images/resize--contain-media.png)
...
![Resize to Fit Within Bounds (Media) reverse transformation](src/pages/guides/learn/how-to/images/resize--within-media-crop.png)
...
![Resize to Cover](src/pages/guides/learn/how-to/images/resize-to-cover.png)
...
![Rescale Text Proportionally](src/pages/guides/learn/how-to/images/rescale--rescale-proportional-text.png)
...
![Resizing and Rescaling Text](src/pages/guides/learn/how-to/images/rescale--rescale-resize-text.png)
