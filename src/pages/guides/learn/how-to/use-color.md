...
```js-data-playground-session-id="createColors"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"-data-playground-url="https://stage.projectx.corp.adobe.com/new"
// sandbox/code.js
...
```js-data-playground-session-id="applyTextColor"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"-data-playground-url="https://stage.projectx.corp.adobe.com/new"
// sandbox/code.js
import { editor, colorUtils } from "express-document-sdk";
...
See the [Use Text](../how-to/use-text.md) page for more examples.
...
```js-data-playground-session-id="applyFillAndStrokeColors"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"-data-playground-url="https://stage.projectx.corp.adobe.com/new"
// sandbox/code.js
import { editor, colorUtils } from "express-document-sdk";
