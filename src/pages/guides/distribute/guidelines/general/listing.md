...
Refer to [Adobe Express Developer Program brand guidelines](../brand_guidelines.md) for more information.
...
Use an original icon that complies with the [Adobe Express Developer Program brand guidelines](https://developer.adobe.com/express/embed-sdk/docs/assets/34359598a6bd85d69f1f09839ec43e12/Adobe_Express_Partner_Program_brand_guide.pdf). Consider using a design that illustrates what the add-on does.
...
You must include details of your policy and agreements. Do not include text that violates [Adobe Express Developer Program brand guidelines](https://developer.adobe.com/express/embed-sdk/docs/assets/34359598a6bd85d69f1f09839ec43e12/Adobe_Express_Partner_Program_brand_guide.pdf).
...
Ensure that all content adheres to [Adobe Express Developer brand guidelines](https://developer.adobe.com/express/embed-sdk/docs/assets/34359598a6bd85d69f1f09839ec43e12/Adobe_Express_Partner_Program_brand_guide.pdf).
...
Include a website so that people can find out more about you. This should successfully open your own website. Specifically, according to page 5 of the [Adobe Express Developer Program brand guidelines](../brand_guidelines.md) your “...domain name must not include any Adobe trademark or product name.”
