...
1. Ensure your add-on UI blends seamlessly with Adobe Express by adhering to the [Adobe Spectrum](../design/spectrum#introduction-to-spectrum) design language and incorporating commonly used patterns found in the Adobe Express UI. While it's not mandatory for add-ons to use Adobe's Spectrum libraries, it can significantly simplify the development process.
