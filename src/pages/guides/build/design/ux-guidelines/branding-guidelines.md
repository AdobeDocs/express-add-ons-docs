...
Please refer to the [Developer Brand Guidelines](https://raw.githubusercontent.com/AdobeDocs/express-add-ons-docs/refs/heads/main/static/pdf/Adobe_Express_Developer_Program_brand_guide_100625.pdf) for comprehensive details on integrating Adobe branding, including when and how to use Adobe logos, product names, and terms.

## Add-on Icon

The add-on's icon should be original, suitable for different devices and browsers, and not violate the [Developer Brand Guidelines](https://raw.githubusercontent.com/AdobeDocs/express-add-ons-docs/refs/heads/main/static/pdf/Adobe_Express_Developer_Program_brand_guide_100625.pdf). Please request a written license agreement from Adobe if you wish to use any Adobe logo, product icon, or image in your preview and feature graphics, product icons, or website.
...
Any image used in your listing must comply with the [Developer Brand Guidelines](https://raw.githubusercontent.com/AdobeDocs/express-add-ons-docs/refs/heads/main/static/pdf/Adobe_Express_Developer_Program_brand_guide_100625.pdf). They should accurately depict the add-on's functionality and features and not contain any misleading information or inappropriate content. The recommended image size is **1360x800** pixels, as PNG or JPG.
