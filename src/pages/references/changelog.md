...
- Both the Code Playground and the CLI now provide [prefixes to the Console messages](../guides/getting_started/code-playground-workflow.md#debugging) to help you distinguish them from other messages.
