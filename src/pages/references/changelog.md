...
- New [Handle Element Selection guide](../guides/learn/how_to/selection_events.md) covering selection operations, real-time selection events, UI integration patterns, selection-based actions, and working with locked elements.
