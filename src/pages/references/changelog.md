...
- **Experimental** [`addMedia()`](./addonsdk/app-document.md#addmedia) method - Batch import multiple media assets to the document in a single operation. This new API supports:
...
- New [`MediaItem`](./addonsdk/app-document.md#mediaitem) interface for defining individual media assets with blob data and optional [`MediaAttributes`](./addonsdk/app-document.md#mediaattributes).

<InlineAlert slots="text" variant="warning"/>

**IMPORTANT:** The [`addMedia()`](./addonsdk/app-document.md#addmedia) method is currently **_experimental only_** and should not be used in any add-ons you will be distributing until it has been declared stable. To use this method, you will first need to set the `experimentalApis` flag to `true` in the [`requirements`](./manifest/index.md#requirements) section of the `manifest.json`.

### Updated

- [Use Images](../guides/learn/how_to/use_images.md) guide updated with new **Batch Import Multiple Images** section covering the `addMedia()` API for importing multiple images and mixed image/video content.
- [Use PDF and PowerPoint](../guides/learn/how_to/use_pdf_powerpoint.md) guide updated with new **Batch Import Multiple PDFs** section covering bulk PDF import using the `addMedia()` API.
