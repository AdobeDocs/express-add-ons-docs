...
- A new version (1.14.0) of the `@adobe/ccweb-add-on-sdk-types` package has been released. Run `npm update` from the root of your add-on project to update to get the latest typings.
