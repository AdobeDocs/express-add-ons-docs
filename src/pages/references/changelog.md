...
While there are redirects in place, please add `https://express.adobe.com/static/oauth-redirect.html` as the redirect URI in your OAuth provider configuration. For more details, see the [OAuth2 guide](../guides/learn/how_to/oauth2.md#login-and-logout-flows).
