...
See this [export content use case example](../../guides/develop/how-to/premium_content.md#show-a-premium-content-error-with-the-upgrade-option), which uses this flag for more details.
