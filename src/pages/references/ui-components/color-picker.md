...
Please also refer to the the Color Picker section of the [Use Color](../../guides/develop/how-to/use_color.md#use-the-color-picker) how-to guide for more examples.
