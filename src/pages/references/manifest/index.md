...
| `script`      | `string`    | File containing the JavaScript code to use with the [authoring sandbox SDK and Adobe Express Document APIs](../authoring/). **Currently experimental only, and requires the [`experimentalApis`](#entrypoints) flag to be set.** |
