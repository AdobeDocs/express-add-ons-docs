...
pages in the document that are not guaranteed to be accessible are represented by the base class, [PageNode](page-node.md).
The entire page encompassing [Context.selection](context.md#selection) and [Context.insertionParent](context.md#insertionparent) is always guaranteed to
be active.
...
any time after the end of the synchronous execution where you first encountered it. Use [Editor.keepContentActiveDuringAsync](editor.md#keepcontentactiveduringasync)
...
```ts
new ActivePageNode(): ActivePageNode;
```
...
[`PageNode`](page-node.md).[`constructor`](page-node.md#constructor)
...
`Readonly`&lt;`Iterable`&lt;[`ArtboardNode`](artboard-node.md)&gt;&gt;
...
[`PageNode`](page-node.md).[`addOnData`](page-node.md#addondata)
...
[`PageNode`](page-node.md).[`id`](page-node.md#id)
...
[`PageNode`](page-node.md).[`type`](page-node.md#type)
...
[`PageNode`](page-node.md).[`parent`](page-node.md#parent)
...
[`PageNode`](page-node.md).[`width`](page-node.md#width)
...
[`PageNode`](page-node.md).[`height`](page-node.md#height)
...
[`PageNode`](page-node.md).[`name`](page-node.md#name)
...
[`PageNode`](page-node.md).[`removeFromParent`](page-node.md#removefromparent)
