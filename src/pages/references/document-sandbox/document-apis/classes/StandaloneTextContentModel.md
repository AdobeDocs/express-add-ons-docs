[@express-document-sdk](../overview.md) / StandaloneTextContentModel
...
• `get` **allTextNodes**(): `Readonly`<`Iterable`<[`StandaloneTextNode`](StandaloneTextNode.md), `any`, `any`\>\>
...
`Readonly`<`Iterable`<[`StandaloneTextNode`](StandaloneTextNode.md), `any`, `any`\>\>
