...
StandaloneTextContentModel represents a complete piece of text content contained within a single [StandaloneTextNode](StandaloneTextNode.md).
...
[`TextNodeContentModel`](TextNodeContentModel.md).[`constructor`](TextNodeContentModel.md#constructor)
...
`Readonly`<`Iterable`<[`StandaloneTextNode`](StandaloneTextNode.md)\>\>

#### Overrides

[`TextNodeContentModel`](TextNodeContentModel.md).[`allTextNodes`](TextNodeContentModel.md#alltextnodes)
...
[`TextNodeContentModel`](TextNodeContentModel.md).[`id`](TextNodeContentModel.md#id)
...
[`TextNodeContentModel`](TextNodeContentModel.md).[`text`](TextNodeContentModel.md#text)
...
[`TextNodeContentModel`](TextNodeContentModel.md).[`characterStyleRanges`](TextNodeContentModel.md#characterstyleranges)
...
[`TextNodeContentModel`](TextNodeContentModel.md).[`paragraphStyleRanges`](TextNodeContentModel.md#paragraphstyleranges)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `range` | [`TextRange`](../interfaces/TextRange.md) | The range of text to delete. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `styles` | [`CharacterStylesInput`](../interfaces/CharacterStylesInput.md) | The styles to apply. |
| `range?` | [`TextRange`](../interfaces/TextRange.md) | The start and length of the character sequence to which the styles should be applied. If no range is specified, styles will be applied to the entire text content flow. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `styles` | [`ParagraphStylesInput`](../interfaces/ParagraphStylesInput.md) | The styles to apply. |
| `range?` | [`TextRange`](../interfaces/TextRange.md) | The start and length of character sequence to which the styles should be applied. Styles apply to any paragraphs that even partially overlap this range. If range is not specified, the styles will be applied to the entire text content flow. |
