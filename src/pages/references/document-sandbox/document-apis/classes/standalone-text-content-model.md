...
StandaloneTextContentModel represents a complete piece of text content contained within a single [StandaloneTextNode](standalone-text-node.md).
...
`Readonly`&lt;`Iterable`&lt;[`StandaloneTextNode`](standalone-text-node.md)&gt;&gt;
