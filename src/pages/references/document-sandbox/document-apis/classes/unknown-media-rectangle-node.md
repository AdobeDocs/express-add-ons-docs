...
```ts
new UnknownMediaRectangleNode(): UnknownMediaRectangleNode;
```
...
[`MediaRectangleNode`](media-rectangle-node.md).[`constructor`](media-rectangle-node.md#constructor)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`addOnData`](media-rectangle-node.md#addondata)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`id`](media-rectangle-node.md#id)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`type`](media-rectangle-node.md#type)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`parent`](media-rectangle-node.md#parent)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`mediaAddOnData`](media-rectangle-node.md#mediaaddondata)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`width`](media-rectangle-node.md#width)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`height`](media-rectangle-node.md#height)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`allChildren`](media-rectangle-node.md#allchildren)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`allDescendants`](media-rectangle-node.md#alldescendants)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`boundsInParent`](media-rectangle-node.md#boundsinparent)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`translation`](media-rectangle-node.md#translation)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`rotation`](media-rectangle-node.md#rotation)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`rotationInScreen`](media-rectangle-node.md#rotationinscreen)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`opacity`](media-rectangle-node.md#opacity)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`transformMatrix`](media-rectangle-node.md#transformmatrix)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`locked`](media-rectangle-node.md#locked)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`blendMode`](media-rectangle-node.md#blendmode)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`visualRoot`](media-rectangle-node.md#visualroot)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`allTextContent`](media-rectangle-node.md#alltextcontent)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`boundsLocal`](media-rectangle-node.md#boundslocal)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`centerPointLocal`](media-rectangle-node.md#centerpointlocal)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`topLeftLocal`](media-rectangle-node.md#topleftlocal)
...
[`MediaRectangleNode`](media-rectangle-node.md).[`hasDescendant`](media-rectangle-node.md#hasdescendant)
