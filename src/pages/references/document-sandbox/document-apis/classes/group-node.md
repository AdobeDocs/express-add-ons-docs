...
The Group's regular children. Does not include the [maskShape](#maskshape) if one is present.
...
[`FillableNode`](fillable-node.md) \| `undefined`
...
| Parameter | Type |
| ------ | ------ |
| `mask` | [`FillableNode`](fillable-node.md) \| `undefined` |
