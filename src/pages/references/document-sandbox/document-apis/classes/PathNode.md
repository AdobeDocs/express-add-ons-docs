...
• `get` **fillRule**(): [`FillRule`](../enumerations/FillRule.md)
...
are permitted. Still, developers should consider if modifying a locked node would align with user expectations
before using the API to change locked nodes.
