...
```ts
new MediaContainerNode(): MediaContainerNode;
```
...
##### Returns
  ...
  \| [`UnknownMediaRectangleNode`](unknown-media-rectangle-node.md)

#### Implementation of

[`IMediaContainerNode`](../interfaces/i-media-container-node.md).[`mediaRectangle`](../interfaces/i-media-container-node.md#mediarectangle)
...
[`IMediaContainerNode`](../interfaces/i-media-container-node.md).[`maskShape`](../interfaces/i-media-container-node.md#maskshape)
...
| ------ | ------ | ------ |
| `media` | [`BitmapImage`](bitmap-image.md) | New content to display. Currently must be a [BitmapImage](bitmap-image.md). |
...
[`IMediaContainerNode`](../interfaces/i-media-container-node.md).[`replaceMedia`](../interfaces/i-media-container-node.md#replacemedia)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `blob` | `Blob` | A blob containing the transformed bitmap derived from the current media. |
| `options` | [`ReplaceMediaWithEditedImageOptions`](../interfaces/replace-media-with-edited-image-options.md) | - |
...
```ts
cloneInPlace(): MediaContainerNode;
```
