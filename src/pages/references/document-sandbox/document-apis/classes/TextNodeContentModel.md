...
# Abstract Class: TextNodeContentModel
...
```ts
new TextNodeContentModel(): TextNodeContentModel;
```
...
[`TextContentModel`](TextContentModel.md).[`constructor`](TextContentModel.md#constructor)
...
[`TextContentModel`](TextContentModel.md).[`id`](TextContentModel.md#id)
...
[`TextContentModel`](TextContentModel.md).[`text`](TextContentModel.md#text)
...
[`TextContentModel`](TextContentModel.md).[`characterStyleRanges`](TextContentModel.md#characterstyleranges)
...
```ts
get abstract allTextNodes(): Readonly<Iterable<TextNode>>;
```
...
[`TextContentModel`](TextContentModel.md).[`paragraphStyleRanges`](TextContentModel.md#paragraphstyleranges)
