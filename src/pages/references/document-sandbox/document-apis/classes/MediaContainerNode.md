...
[`IMediaContainerNode`](../interfaces/IMediaContainerNode.md).[`mediaRectangle`](../interfaces/IMediaContainerNode.md#mediarectangle)
...
[`IMediaContainerNode`](../interfaces/IMediaContainerNode.md).[`maskShape`](../interfaces/IMediaContainerNode.md#maskshape)
...
| ------ | ------ | ------ |
| `media` | [`BitmapImage`](BitmapImage.md) | New content to display. Currently must be a [BitmapImage](BitmapImage.md). |
