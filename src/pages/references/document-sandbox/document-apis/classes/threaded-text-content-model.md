...
• `get` **allTextNodes**(): `Readonly`<`Iterable`<[`ThreadedTextNode`](threaded-text-node.md), `any`, `any`\>\>
...
`Readonly`<`Iterable`<[`ThreadedTextNode`](threaded-text-node.md), `any`, `any`\>\>
...
• `get` **frames**(): [`ThreadedTextList`](threaded-text-list.md)
