...
```ts
new ThreadedTextNode(): ThreadedTextNode;
```
...
[`TextNode`](text-node.md).[`constructor`](text-node.md#constructor)
...
[`TextNode`](text-node.md).[`addOnData`](text-node.md#addondata)
...
[`TextNode`](text-node.md).[`id`](text-node.md#id)
...
[`TextNode`](text-node.md).[`type`](text-node.md#type)
...
[`TextNode`](text-node.md).[`parent`](text-node.md#parent)
...
[`TextNode`](text-node.md).[`allChildren`](text-node.md#allchildren)
...
[`TextNode`](text-node.md).[`allDescendants`](text-node.md#alldescendants)
...
[`TextNode`](text-node.md).[`translation`](text-node.md#translation)
...
[`TextNode`](text-node.md).[`rotation`](text-node.md#rotation)
...
[`TextNode`](text-node.md).[`rotationInScreen`](text-node.md#rotationinscreen)
...
[`TextNode`](text-node.md).[`boundsLocal`](text-node.md#boundslocal)
...
[`TextNode`](text-node.md).[`centerPointLocal`](text-node.md#centerpointlocal)
...
[`TextNode`](text-node.md).[`boundsInParent`](text-node.md#boundsinparent)
...
[`TextNode`](text-node.md).[`opacity`](text-node.md#opacity)
...
[`TextNode`](text-node.md).[`transformMatrix`](text-node.md#transformmatrix)
...
[`TextNode`](text-node.md).[`locked`](text-node.md#locked)
...
[`TextNode`](text-node.md).[`blendMode`](text-node.md#blendmode)
...
[`TextNode`](text-node.md).[`topLeftLocal`](text-node.md#topleftlocal)
...
[`TextNode`](text-node.md).[`text`](text-node.md#text)
...
[`TextNode`](text-node.md).[`textAlignment`](text-node.md#textalignment)
...
[`TextNode`](text-node.md).[`visualEffects`](text-node.md#visualeffects)
...
same single [ThreadedTextContentModel](threaded-text-content-model.md); this can give the impression that the same text is duplicated multiple times when it is
not. Use [ThreadedTextContentModel](threaded-text-content-model.md).id to determine whether a given piece of text content is unique or if it's already been
encountered before.

##### Returns

[`ThreadedTextContentModel`](threaded-text-content-model.md)

#### Overrides

[`TextNode`](text-node.md).[`fullContent`](text-node.md#fullcontent)
...
[`TextNode`](text-node.md).[`nextTextNode`](text-node.md#nexttextnode)
...
| Parameter | Type |
| ------ | ------ |
| `layout` | [`AreaTextLayout`](../interfaces/area-text-layout.md) |
...
[`TextNode`](text-node.md).[`layout`](text-node.md#layout)
...
[`TextNode`](text-node.md).[`visualRoot`](text-node.md#visualroot)
...
via manual tree traversal since multiple ThreadedTextNode can share a single [TextContentModel](text-content-model.md).
...
[`TextNode`](text-node.md).[`allTextContent`](text-node.md#alltextcontent)
...
[`TextNode`](text-node.md).[`removeFromParent`](text-node.md#removefromparent)
...
[`TextNode`](text-node.md).[`setPositionInParent`](text-node.md#setpositioninparent)
...
[`TextNode`](text-node.md).[`setRotationInParent`](text-node.md#setrotationinparent)
...
[`TextNode`](text-node.md).[`resize`](text-node.md#resize)
...
[`TextNode`](text-node.md).[`isStandaloneText`](text-node.md#isstandalonetext)
...
[`TextNode`](text-node.md).[`isThreadedText`](text-node.md#isthreadedtext)
...
[`TextNode`](text-node.md).[`hasDescendant`](text-node.md#hasdescendant)
...
[`TextNode`](text-node.md).[`localPointInNode`](text-node.md#localpointinnode)
...
[`TextNode`](text-node.md).[`createRendition`](text-node.md#createrendition)
