...
Because the resulting BitmapImage is returned asynchronously, to use it you must call [createImageContainer](editor.md#createimagecontainer)
inside a [Editor.keepContentActiveDuringAsync](editor.md#keepcontentactiveduringasync) `afterAsyncCallback`.
