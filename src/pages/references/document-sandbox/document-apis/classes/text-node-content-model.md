...
[`TextContentModel`](text-content-model.md).[`constructor`](text-content-model.md#constructor)
...
[`TextContentModel`](text-content-model.md).[`id`](text-content-model.md#id)
...
[`TextContentModel`](text-content-model.md).[`text`](text-content-model.md#text)
...
[`TextContentModel`](text-content-model.md).[`characterStyleRanges`](text-content-model.md#characterstyleranges)
...
[`TextContentModel`](text-content-model.md).[`paragraphStyleRanges`](text-content-model.md#paragraphstyleranges)
