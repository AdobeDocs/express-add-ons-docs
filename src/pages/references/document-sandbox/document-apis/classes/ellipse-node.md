...
[`FillableNode`](fillable-node.md).[`constructor`](fillable-node.md#constructor)
...
[`FillableNode`](fillable-node.md).[`addOnData`](fillable-node.md#addondata)
...
[`FillableNode`](fillable-node.md).[`id`](fillable-node.md#id)
...
[`FillableNode`](fillable-node.md).[`type`](fillable-node.md#type)
...
[`FillableNode`](fillable-node.md).[`parent`](fillable-node.md#parent)
...
Must be at least MIN\_DIMENSION / 2.
...
[`FillableNode`](fillable-node.md).[`fill`](fillable-node.md#fill)
...
[`FillableNode`](fillable-node.md).[`allChildren`](fillable-node.md#allchildren)
...
[`FillableNode`](fillable-node.md).[`allDescendants`](fillable-node.md#alldescendants)
...
[`FillableNode`](fillable-node.md).[`boundsInParent`](fillable-node.md#boundsinparent)
...
[`FillableNode`](fillable-node.md).[`translation`](fillable-node.md#translation)
...
[`FillableNode`](fillable-node.md).[`rotation`](fillable-node.md#rotation)
...
[`FillableNode`](fillable-node.md).[`rotationInScreen`](fillable-node.md#rotationinscreen)
...
[`FillableNode`](fillable-node.md).[`opacity`](fillable-node.md#opacity)
...
[`FillableNode`](fillable-node.md).[`transformMatrix`](fillable-node.md#transformmatrix)
...
[`FillableNode`](fillable-node.md).[`locked`](fillable-node.md#locked)
...
[`FillableNode`](fillable-node.md).[`blendMode`](fillable-node.md#blendmode)
...
[`FillableNode`](fillable-node.md).[`stroke`](fillable-node.md#stroke)
...
[`FillableNode`](fillable-node.md).[`visualRoot`](fillable-node.md#visualroot)
...
[`FillableNode`](fillable-node.md).[`allTextContent`](fillable-node.md#alltextcontent)
...
[`FillableNode`](fillable-node.md).[`boundsLocal`](fillable-node.md#boundslocal)
...
[`FillableNode`](fillable-node.md).[`centerPointLocal`](fillable-node.md#centerpointlocal)
...
[`FillableNode`](fillable-node.md).[`topLeftLocal`](fillable-node.md#topleftlocal)
