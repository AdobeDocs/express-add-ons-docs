...
| ------ | ------ |
| [Constants](constants/overview.md) | - |
...
| [ThreadedTextContentModel](classes/threaded-text-content-model.md) | ThreadedTextContentModel represents a complete piece of text content that is split across multiple [ThreadedTextNode](classes/threaded-text-node.md) frames for display. Use [frames](classes/threaded-text-content-model.md#frames) to access the list of display frames and add new ones via [ThreadedTextList.addFrame](classes/threaded-text-list.md#addframe). |
...
| ------ | ------ |
| [TextContent](interfaces/text-content.md) | **Experimental** |
...
| [ReplaceMediaWithEditedImageOptions](interfaces/replace-media-with-edited-image-options.md) | **Experimental** |
...
| [CreateRenditionOptions](interfaces/create-rendition-options.md) | **Experimental** |
| [CreateRenditionResult](interfaces/create-rendition-result.md) | **Experimental** |
