            ...
            pages: [
              {
                ...
                pages: [
                  ...
                  {
                    title: "BitmapImage",
                    path: "references/document-sandbox/document-apis/classes/bitmap-image.md",
                  },
                  {
                    title: "ColorUtils",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/classes/express-context.md",
                  },
                  {
                    title: "ExpressEditor",
                    path: "references/document-sandbox/document-apis/classes/express-editor.md",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/classes/express-viewport.md",
                  },
                  {
                    title: "FillableNode",
                  ...
                  {
                    title: "ReadOnlyMask",
                    path: "references/document-sandbox/document-apis/classes/read-only-mask.md",
                  },
                  {
                    title: "RectangleNode",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/classes/standalone-text-content-model.md",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/classes/text-node-content-model.md",
                  },
                  {
                    title: "ThreadedTextContentModel",
                    path: "references/document-sandbox/document-apis/classes/threaded-text-content-model.md",
                  },
                  {
                    title: "ThreadedTextList",
                    path: "references/document-sandbox/document-apis/classes/threaded-text-list.md",
                  },
                  {
              ...
              },
              {
                ...
                pages: [
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/interfaces/common-resize-options.md",
                  },
                  {
                    title: "ContainerNode",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/interfaces/create-rendition-options.md",
                  },
                  {
                    title: "CreateRenditionResult",
                    path: "references/document-sandbox/document-apis/interfaces/create-rendition-result.md",
                  },
                  {
                    title: "Fill",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/interfaces/i-media-container-node.md",
                  },
                  {
                    title: "INodeBounds",
                    path: "references/document-sandbox/document-apis/interfaces/i-node-bounds.md",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/interfaces/i-visual-node-bounds.md",
                  },
                  {
                    title: "ListItem",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/interfaces/remove-list-style-input.md",
                  },
                  {
                    title: "RescaleProportionalToHeightOptions",
                    path: "references/document-sandbox/document-apis/interfaces/rescale-proportional-to-height-options.md",
                  },
                  {
                    title: "RescaleProportionalToWidthOptions",
                    path: "references/document-sandbox/document-apis/interfaces/rescale-proportional-to-width-options.md",
                  },
                  {
                    title: "ResizeUsingHeightOptions",
                    path: "references/document-sandbox/document-apis/interfaces/resize-using-height-options.md",
                  },
                  {
                    title: "ResizeUsingWidthOptions",
                    path: "references/document-sandbox/document-apis/interfaces/resize-using-width-options.md",
                  },
                  {
                    title: "SolidColorStroke",
                    path: "references/document-sandbox/document-apis/interfaces/solid-color-stroke.md",
                  },
                  {
                    title: "Stroke",
                  ...
                  {
                    title: "TextContent",
                    path: "references/document-sandbox/document-apis/interfaces/text-content.md",
                  },
                  {
                    title: "TextFrameAreaGeometry",
                    path: "references/document-sandbox/document-apis/interfaces/text-frame-area-geometry.md",
                  },
                  {
                    title: "TextRange",
              ...
              },
              {
                ...
                pages: [
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/namespaces/constants/enumerations/create-rendition-format.md",
                  },
                  {
                    title: "EditorEvent",
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/enumerations/resize-behavior.md",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/namespaces/constants/enumerations/text-style-source.md",
                  },
                  {
              ...
              },
              {
                ...
                pages: [
                  ...
                  },
                  {
                    ...
                    path: "references/document-sandbox/document-apis/type-aliases/list-style-input.md",
                  },
                  {
                  ...
                  {
                    title: "ResizeOptions",
                    path: "references/document-sandbox/document-apis/type-aliases/resize-options.md",
                  },
                  {
      ...
      },
      {
        ...
        pages: [
          ...
          },
          {
            ...
            path: "guides/getting-started/addon-project-anatomy.md",
          },
          {
            ...
            pages: [
              ...
              {
                title: "Script Mode",
                path: "guides/getting-started/code-playground-script-mode.md",
              },
              {
                title: "Add-on Mode",
                path: "guides/getting-started/code-playground-addon-mode.md",
              },
              {
                title: "Workflow & Productivity",
                path: "guides/getting-started/code-playground-workflow.md",
              },
              {
                title: "Troubleshooting",
                path: "guides/getting-started/code-playground-troubleshooting.md",
              },
            ],
          },
          {
            title: "Dev MCP Server",
            path: "guides/getting-started/local-development/mcp-server.md",
          },
          {
            ...
            pages: [
              ...
              },
              {
                ...
                path: "guides/getting-started/local-development/known-issues-limitations.md",
              },
            ],
          },
          {
      ...
      },
      {
        ...
        pages: [
              ...
              },
              {
                ...
                pages: [
                  ...
                  },
                  {
                    ...
                    path: "guides/learn/how-to/resize-elements.md",
                  },
                  {
          ...
          },
          {
            ...
            path: "guides/learn/platform-concepts/architecture.md",
            pages: [
              {
          ...
          },
          {
            ...
            pages: [
              ...
              },
              {
                ...
                path: "guides/build/design/best-practices.md",
              },
            ],
          },
          {
